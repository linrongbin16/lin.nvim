...
return {
    ...
    {
        -- stars:564, repo:https://github.com/bluz71/vim-moonfly-colors
        "bluz71/vim-moonfly-colors",
        lazy = true,
        priority = 1000,
    },
    {
        -- stars:585, repo:https://github.com/bluz71/vim-nightfly-colors
        "bluz71/vim-nightfly-colors",
        lazy = true,
        priority = 1000,
    },
    {
        -- stars:2400, repo:https://github.com/catppuccin/nvim
        "catppuccin/nvim",
        lazy = true,
        priority = 1000,
        name = "catppuccin",
    ...
    {
        -- stars:1982, repo:https://github.com/cocopon/iceberg.vim
        "cocopon/iceberg.vim",
        lazy = true,
        priority = 1000,
    },
    ...
    {
        -- stars:2000, repo:https://github.com/EdenEast/nightfox.nvim
        "EdenEast/nightfox.nvim",
        lazy = true,
        priority = 1000,
    },
    {
        -- stars:909, repo:https://github.com/ellisonleao/gruvbox.nvim
    ...
    {
        -- stars:626, repo:https://github.com/fenetikm/falcon
        "fenetikm/falcon",
        lazy = true,
        priority = 1000,
    },
    {
        -- stars:3300, repo:https://github.com/folke/tokyonight.nvim
    ...
    {
        -- stars:832, repo:https://github.com/jnurmine/zenburn
        "jnurmine/zenburn",
        lazy = true,
        priority = 1000,
    },
    {
        -- stars:1567, repo:https://github.com/junegunn/seoul256.vim
        "junegunn/seoul256.vim",
        lazy = true,
        priority = 1000,
    },
    {
        -- stars:914, repo:https://github.com/lifepillar/vim-solarized8
        "lifepillar/vim-solarized8",
        lazy = true,
        priority = 1000,
    },
    {
        -- stars:726, repo:https://github.com/marko-cerovac/material.nvim
        "marko-cerovac/material.nvim",
        lazy = true,
        priority = 1000,
    },
    {
        -- stars:889, repo:https://github.com/navarasu/onedark.nvim
        "navarasu/onedark.nvim",
        lazy = true,
        priority = 1000,
    },
    {
        -- stars:2461, repo:https://github.com/nlknguyen/papercolor-theme
    ...
    {
        -- stars:709, repo:https://github.com/pineapplegiant/spaceduck
        "pineapplegiant/spaceduck",
        lazy = true,
        priority = 1000,
    },
    {
        -- stars:577, repo:https://github.com/preservim/vim-colors-pencil
    ...
    {
        -- stars:762, repo:https://github.com/raphamorim/lucario
        "raphamorim/lucario",
        lazy = true,
        priority = 1000,
    },
    ...
    {
        -- stars:830, repo:https://github.com/romainl/apprentice
        "romainl/apprentice",
        lazy = true,
        priority = 1000,
    },
    {
        -- stars:848, repo:https://github.com/rose-pine/neovim
        "rose-pine/neovim",
        lazy = true,
        priority = 1000,
        name = "rose-pine",
    ...
    {
        -- stars:706, repo:https://github.com/sainnhe/edge
        "sainnhe/edge",
        lazy = true,
        priority = 1000,
    },
    {
        -- stars:1800, repo:https://github.com/sainnhe/everforest
        "sainnhe/everforest",
        lazy = true,
        priority = 1000,
    },
    ...
    {
        -- stars:1200, repo:https://github.com/sainnhe/sonokai
        "sainnhe/sonokai",
        lazy = true,
        priority = 1000,
    },
    {
        -- stars:577, repo:https://github.com/shaunsingh/nord.nvim
    ...
    {
        -- stars:745, repo:https://github.com/srcery-colors/srcery-vim
        "srcery-colors/srcery-vim",
        lazy = true,
        priority = 1000,
    },
    {
        -- stars:839, repo:https://github.com/tomasiser/vim-code-dark

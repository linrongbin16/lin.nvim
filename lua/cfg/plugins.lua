...
return {
    ...
    },
    {
        ...
        event = { 'BufReadPost' },
        init = function()
            vim.cmd('source $HOME/.nvim/repo/ludovicchabant/vim-gutentags/init.vim')
        end
    },
    ...
    -- Auto-complete engine
    {
        ...
        dependencies = { 'neovim/nvim-lspconfig', 'hrsh7th/cmp-nvim-lsp', 'hrsh7th/cmp-buffer', 'hrsh7th/cmp-path', 'hrsh7th/cmp-cmdline', 'L3MON4D3/LuaSnip', 'saadparwaiz1/cmp_luasnip', 'quangnguyen30192/cmp-nvim-tags' },
        config = function()
...

    {
        ...
        cmd = { 'GitBlameOpenCommitURL', 'GitBlameToggle', 'GitBlameEnable', 'GitBlameDisable', 'GitBlameCopySHA', 'GitBlameCopyCommitURL' },
        init = function()
    ...
    -- Terminal
    {
        ...
        version = '*',
        cmd = { 'TermExec', 'ToggleTerm', 'ToggleTermToggleAll', 'ToggleTermSendVisualLines', 'ToggleTermSendVisualSelection', 'ToggleTermSendCurrentLine', 'ToggleTermSetName' },
        config = function()

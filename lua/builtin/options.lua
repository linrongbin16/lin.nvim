...
-- clean highlight
vim.keymap.set('n', '<C-L>', ":nohlsearch<C-R>=has('diff')?'<Bar>diffupdate':''<CR><CR><C-L>", {noremap=true,silent=true,desc="Clear highlight"})
...
vim.api.nvim_create_augroup("checktime_augroup", { clear = true })

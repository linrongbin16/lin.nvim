...
class Plugin:
    def __init__(
        ...
        self.above = comments  # more clauses above this line
        self.color = color
        self.tag = tag
...
PLUGINS = [
    ...
    Plugin(
        ...
        comments=Exprs([BigComment("UI"), SmallComment("File explorer")]),
        tag=Tag.UI,
    ),
    Plugin(
    ...
    Plugin(
        ...
        comments=Exprs([BigComment("Language support"), SmallComment("Markdown")]),
        tag=Tag.LANGUAGE,
    ),
    Plugin(

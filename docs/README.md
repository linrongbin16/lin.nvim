...
Check out [features](/features.md) for what it can do, [colorschemes](/colorschemes.md) for pretty colorschemes and icons, the [philosophy](/philosophy.md) I follow when maintaining this config.
